...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"projFormContainer":"Pzz_vz3YVnbQKAA7NGnh","projForm":"wgVHguY03UwCdSqp5FVR","addButton":"V5GWUxuNQfYT4QFxaNDq","hidden":"VpqBr8JAIc4rqO5Boy3h","containerDiv":"VXbZotjOoSill62h_i98","headerDiv":"ITgkPv3_it4uIaA3Kq3l","mainDiv":"hYQNB8z5lEUcW6tDlrFK","leftSideDiv":"EIa0FbZu808wWRcMkmog","projList":"cUJGEFu6mVi_aO5nLMlr","listItem":"ZoivsxlN2DrH2lWBysGb","newProjectBtn":"WL0aK3zARjqn8Cf5gaKR","rightSideDiv":"u_b3kqxWbWjQ7Y6r6WGg","rightSideHeading":"OZoEFT1b2QUA5M2kTwOv","rightContainer":"MH1umxZaZ574LOPdaAoF","taskContainer":"APzRZHbN8KjGew46ELQS","taskDiv":"GW08oEo1I_Xq8nYa193y","inputContainer":"SJjKa1hBPy7C_aPAqvft","inputBox":"cwKe5BfdZ7Fa0xGsim1O","radioContainer":"WKxeZWhkkwsTuHgGq7jE","lowRadioDiv":"R7loIBFayyxBNqcbYfYj","highRadioDiv":"gBbKp0P2ldNNYqPZR_nl","newTaskBtn":"iQvOvPf3xYwevNThK4MA","incompleteTask":"RlYUMwzJwHTH_2NXExm0","completeTask":"nmZk_rYFKYg6tpmxEa4V","markCompleteDiv":"sgeVUOnhViIuR_07NeIQ","deleteTaskDiv":"oHbiBe2LB7mAxtaR6_qu","showDateDiv":"MSRiPj8SoLIDBzKsdylq","removeProjBtn":"pWtQGqzn9rnMPFZVnRHG"});
...
/* harmony export */ });
/* harmony import */ var _index_module_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.module.scss */ "./src/UI_todo/index.module.scss");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
    ...
    projFormContainer.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].projFormContainer, _index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].hidden);
    const projForm = document.createElement('form');
    projForm.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].projForm);
    ...
    addButton.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].addButton);
    ...
    containerDiv.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].containerDiv);

    // Header 
    const h1 = document.createElement('h1');
    const headerDiv = createDiv();
    h1.innerText = 'WHAT TO-DO';
    headerDiv.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].headerDiv);
    headerDiv.appendChild(h1);
    

    // Main Content
    const mainDiv = createDiv();
    mainDiv.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].mainDiv);

        // Left Side Div
        const leftSideDiv = createDiv();
        const newProjectBtn = document.createElement("button");
        newProjectBtn.textContent = "Add New Project";
        newProjectBtn.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].newProjectBtn);
        const leftSideHeading = createH2();
        leftSideHeading.innerText = 'Projects';
        leftSideHeading.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].leftSideHeading);
        const projList = createDiv();
        projList.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].projList);
        leftSideDiv.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].leftSideDiv);
        ...
        rightSideHeading.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].rightSideHeading);
        rightSideDiv.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].rightSideDiv, _index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].hidden);
        rightSideDiv.appendChild(rightSideHeading);

            // Right container div
            const rightContainer = createDiv();
            rightContainer.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].rightContainer);

                // Task Container
                const taskContainer = createDiv();
                taskContainer.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].taskContainer);
                ...
                const form = document.createElement('form');
                    ...
                    inputContainer.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].inputContainer);
                    const enterTask = createInput();
                    enterTask.placeholder = "write your new task here...";
                    enterTask.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].inputBox);
                    const enterDate = createInput();
                    enterDate.type = "date";
                    enterDate.placeholder = "enter due date...";
                    enterDate.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].inputBox);
                    const enterTaskDescription = createInput();
                    enterTaskDescription.placeholder = "write task description...";
                    enterTaskDescription.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].inputBox);
                        

                    // Radio Container
                    const radioContainer = createDiv();
                    radioContainer.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].radioContainer);
                    ...
                    highRadioDiv.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].highRadioDiv);
                    const lowRadioDiv = createDiv();
                    lowRadioDiv.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].lowRadioDiv);
                    ...
                    newTaskBtn.classList.add(_index_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].newTaskBtn);
...
/* harmony import */ var _UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./UI_todo/index.module.scss */ "./src/UI_todo/index.module.scss");
...
const ALLUI = (0,_UI_todo_index_js__WEBPACK_IMPORTED_MODULE_2__["default"])();
let currentProj;
const projectLists = [];
let sampleProj = new _to_do_engine_project_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
let localProjList;
...
let today = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), 'dd-MM-yyyy');
let defaultTodo = new _to_do_engine_todo_js__WEBPACK_IMPORTED_MODULE_1__["default"]("Default to-do", "this is the default todo", today, "low");
...
function addProjectsToUI() {
    ...
    projectLists.forEach((element, index) => {
        ...
        listItem.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].listItem);

        const removeProjBtn = document.createElement('div');
        removeProjBtn.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].removeProjBtn);
...
function deleteProj (index) {
    ...
    if (projName == ALLUI.rightSideHeading.textContent) {
        ALLUI.rightSideDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].hidden);
    }
    addProjectsToUI();
}
...
ALLUI.newProjectBtn.addEventListener('click', () => {
    ALLUI.projFormContainer.classList.remove(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].hidden);
...
ALLUI.addButton.addEventListener('click', (e) => {
    ...
    ALLUI.projFormContainer.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].hidden);
});
...
ALLUI.leftSideDiv.addEventListener('click', (e) => {
    if (e.target.parentNode.tagName === "LI") {
        ...
        ALLUI.rightSideDiv.classList.remove(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].hidden);
...
ALLUI.newTaskBtn.addEventListener('click', (e) => {
    ...
    const taskDueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(ALLUI.enterDate.value), 'dd-MM-yyyy');
    ...
    const todo = new _to_do_engine_todo_js__WEBPACK_IMPORTED_MODULE_1__["default"](taskName, taskDesc, taskDueDate, priority);
...
function stackTodos(projId) {
    ...
    projectLists[projId].todo_list.forEach((element, index) => {
        ...
        if (element.completed == false || element._completed == false) {
            taskDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].incompleteTask); 
        } else {
            taskDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].completeTask);
        }
        taskDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].taskDiv);
        const taskName = document.createElement('span');
        taskName.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].taskName);
        ...
        showDateDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].showDateDiv);
        showDateDiv.textContent = element.dueDate;

        const markCompleteDiv = document.createElement('div');
        markCompleteDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].markCompleteDiv);

        const deleteTaskDiv = document.createElement('div');
        deleteTaskDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].deleteTaskDiv);
...
function markTaskComplete(element, taskDiv) {
    ...
    taskDiv.classList.remove(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].incompleteTask);
    taskDiv.classList.add(_UI_todo_index_module_scss__WEBPACK_IMPORTED_MODULE_3__["default"].completeTask);
    setLocalStorage();
}
